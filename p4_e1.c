 ...
 *
 * Si al ejecutar el programa utilizamos el fichero que sólo tiene 10 canciones, el modo normal es más rápido a pesar de ser
 * más profundo debido a que el modo sorted tiene que ordenarse. Sin embargo, si utilizamos el fichero con 1000 canciones, aunque
 * el modo sorted siga teniendo que ejecutar el algoritmo de ordenación, esta vez es más rápido que el modo normal ya que
 * la profundidad del arbol es mucho menor.
 */